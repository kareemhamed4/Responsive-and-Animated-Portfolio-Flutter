                ...
                child: Column(
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        _launchInBrowser(
                          //https://drive.google.com/file/d/1GPWgmm4PgZMr_ahW6KFmlDcqDiEkelY2/view?usp=sharing
                          Uri(scheme: 'https', host: 'drive.google.com', path: '/file/d/1GPWgmm4PgZMr_ahW6KFmlDcqDiEkelY2/view'),
                        );
                      },
                      child: FittedBox(
                        child: Row(
